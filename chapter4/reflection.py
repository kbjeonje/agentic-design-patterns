...
refinement_chain = (
    ChatPromptTemplate.from_messages([
        ...
        ("user", "Please provide the refined description.") # User input is empty as the context is provided in the system message
    ])
    | llm
    | StrOutputParser()
)
...
if __name__ == "__main__":
    ...
    # Fix: Directly await the coroutine in Colab environments
...
--- Final Refined Product Description ---
Based on the critique and suggested revisions, here is the refined product description:

**Refined Product Description:**

"Never settle for cold coffee again. Enjoy every sip at your ideal temperature, controlled effortlessly from your smartphone."
"""
